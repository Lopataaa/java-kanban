...
public abstract class BaseHttpHandler implements HttpHandler {
    ...
    protected void sendText(HttpExchange h, String text, int statusCode) throws IOException { // зачем int statusCode
        byte[] resp = text.getBytes(StandardCharsets.UTF_8);
        h.getResponseHeaders().add("Content-Type", "application/json;charset=utf-8");
        h.sendResponseHeaders(statusCode, resp.length); // вместо д.б 200??
    ...
    protected void sendHasInteractions(HttpExchange h) throws IOException {
        sendText(h, "Task overlaps with existing tasks", 406);
    }
    ...
    protected <T> void handleGetRequest(HttpExchange h, String path, String basePath,
